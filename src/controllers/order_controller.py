...
"""
from commands.write_order import add_order, delete_order, sync_all_orders_to_redis, sync_products_to_redis
from queries.read_order import get_highest_sold_items, get_highest_sold_items_redis, get_highest_spending_users, get_orders_from_mysql, get_orders_from_redis
...
def populate_redis_from_mysql():
   ...
   sync_products_to_redis()
   
def get_report_highest_spending_users():
    """Get orders report: highest spending users"""
    return get_highest_spending_users()

def get_report_highest_sold_items():
    """Get orders report: highest sold items"""
    return get_highest_sold_items()

def get_report_highest_sold_items_redis():
    """Get orders report: highest sold items"""
    return get_highest_sold_items_redis()
